...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-12-2022 a las 17:59:26
...
('Luca', 'Tejada', 44662123, 2617475404, 'o+', 100, 2, 'no', 'no', 'no', 'no', '', 'no- ', 'no- ', 'no- - - ', 'no- ', 'no- ', 'no-  ', '', 'no- - ', 'padre- madre- hermanos- - ', '', 'Mike', 32570896, 2616448909, 'Ninguno', NULL),
('Luca', 'Tejada', 44662123, 2617475404, 'o+', 100, 2, 'no', 'no', 'no', 'no', 'sarampion- paperas- ', 'no- ', 'no- ', 'no- - - ', 'no- ', 'no- ', 'no-  ', '', 'no- - ', 'padre- madre- hermanos- - ', '', 'Mike', 32570896, 2616448909, 'Ninguno', NULL);
...
(123, 'Agustin', 'Videla', 542617475404, 4, 14, 2, NULL),
(456, 'Javier', 'Garcia', 456, 1, 18, 2, NULL),
(789, 'Luca', 'Tejada', 789, 1, 19, 1, NULL),
(2222, 'aaaa', 'aaaaa', 2222, 1, 17, 3, NULL),
(161102, 'sujeto', 'prueba', 2617475566, 2, 18, 3, NULL);
